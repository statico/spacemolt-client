...
export default class TypeBuilder {
    ...
    GameAction: ClassViewer<'GameAction', "command" | "args" | "reasoning">;
    
    PlayerIdentity: ClassViewer<'PlayerIdentity', "username" | "empire">;
    
    
    Command: EnumViewer<'Command', "Travel" | "Jump" | "Dock" | "Undock" | "Mine" | "Attack" | "Scan" | "Buy" | "Sell" | "Refuel" | "Repair" | "Craft" | "Say" | "Faction" | "Msg" | "Status" | "System" | "Poi" | "Base">;
    
    Empire: EnumViewer<'Empire', "Solarian" | "Voidborn" | "Crimson" | "Nebula" | "Outerrim">;
    

    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "GameAction","PlayerIdentity",
          ]),
          enums: new Set([
            "Command","Empire",
          ]),
        ...
        this.GameAction = this.tb.classViewer("GameAction", [
          "command","args","reasoning",
        ]);
        
        this.PlayerIdentity = this.tb.classViewer("PlayerIdentity", [
          "username","empire",
        ]);
        
        
        this.Command = this.tb.enumViewer("Command", [
          "Travel","Jump","Dock","Undock","Mine","Attack","Scan","Buy","Sell","Refuel","Repair","Craft","Say","Faction","Msg","Status","System","Poi","Base",
        ]);
        
        this.Empire = this.tb.enumViewer("Empire", [
