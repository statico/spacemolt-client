...
import type {Command, Empire, GameAction, PlayerIdentity} from "./types"
...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async DecideAction(
        game_state: string,strategy: string,recent_events: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.GameAction> {
          try {
          ...
          const __stream__ = this.stream.DecideAction(
          game_state,strategy,recent_events,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "DecideAction",
            {
            "game_state": game_state,"strategy": strategy,"recent_events": recent_events
            },
            ...
            return __raw__.parsed(false) as types.GameAction
            } catch (error) {
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.GenerateIdentity(
          play_style,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.PlayerIdentity
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            game_state: string,strategy: string,recent_events: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.GameAction, types.GameAction>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for DecideAction", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.GameAction, types.GameAction>(
                  __raw__,
                  (a): partial_types.GameAction => a,
                  (a): types.GameAction => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            play_style: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.PlayerIdentity, types.PlayerIdentity>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for GenerateIdentity", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.PlayerIdentity, types.PlayerIdentity>(
                  __raw__,
                  (a): partial_types.PlayerIdentity => a,
                  (a): types.PlayerIdentity => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
